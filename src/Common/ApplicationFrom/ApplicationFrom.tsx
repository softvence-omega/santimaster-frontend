const OpenGeneApplicationForm = () => {
  return (
    <div className="max-w-3xl mx-auto p-6 bg-[#FAFAFA] rounded-sm w-fit  py-40">
      {/* Title */}
      ...
      <div className="mb-6">
        <label className="flex items-center text-sm text-gray-700">
          <input type="checkbox" className="mr-2" />I confirm that I agree to
          the Privacy Policy and consent to store my application data for review
          purposes.
        </label>
      </div>
