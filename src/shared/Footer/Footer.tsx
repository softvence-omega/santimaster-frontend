...
import logo from "../../assets/logo/fotter-logo.png";
const Footer = () => {
    ...
    <div className="min-h-screen bg-gray-50 relative ">
      ...
      <div className="px-4 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          {/* ----------Newsletter Card -------------*/}
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 translate-y-60 absolute top-20 left-[25%] z-50 w-[800px]">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-700">New protocol releases</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-5 h-5 bg-gray-800 rounded-sm flex items-center justify-center">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-700">Community highlights</span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <button className="w-full bg-green-500 hover:bg-green-600 text-white font-medium py-3 px-6 rounded-lg transition-colors">
      ...
      <footer className="relative  overflow-hidden">
        ...
        <div className=" px-4 py-58 relative z-10 translate-y-20">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-1">
              ...
              <p className="text-green-100 text-sm leading-relaxed">
                Open, peer-reviewed protocols for CRISPR, CAR-T, and AI-designed
                mRNA research. Accelerating biotechnology through collaborative
                science.
              </p>
            </div>
