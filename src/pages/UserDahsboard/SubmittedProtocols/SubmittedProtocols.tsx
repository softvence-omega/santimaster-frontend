...
const StatusBadge: React.FC<{ status: ProtocolCardProps['status'] }> = ({ status }) => {
  ...
  const protocols: ProtocolCardProps[] = [
    {
      ...
      description: "Comprehensive protocol for purifying recombinant proteins using affinity chromatography...",
      reviewer: {
      ...
      reviewerNote: "Please provide more details on buffer composition and pH optimization steps. Overall structure is good."
    },
    {
      title: "CRISPR-Cas9 Gene Editing in E. coli",
      description: "Detailed protocol for targeted gene editing using CRISPR-Cas9 system in bacterial cells...",
      reviewer: {
      ...
      reviewerNote: "Excellent protocol with clear methodology and comprehensive troubleshooting section. Approved for publication."
    },
    {
      title: "Western Blot Analysis Protocol",
      description: "Standard protocol for protein detection using western blot technique with optimization tips...",
      reviewer: {
        name: "Unassigned"
      },
      submitted: "March 10, 2024",
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-gray-50 min-h-screen">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Submitted Protocols</h1>
