  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
      ...
      <div className="flex justify-between items-start mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Priority Review Queue</h1>
          <p className="text-gray-600">Submissions requiring immediate attention</p>
        </div>
          ...
          >
            ...
            <div className="flex items-start justify-between mb-3">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getRiskLevelStyle(submission.riskLevel)}`}>
                  {submission.riskLevel}
                </span>
                {submission.priority && (
                  <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${submission.priorityColor}`}>
                    {submission.priority}
                  </span>
                )}
              </div>
