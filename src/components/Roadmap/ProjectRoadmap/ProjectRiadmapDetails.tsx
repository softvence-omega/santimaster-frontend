        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <p className="text-gray-600 leading-relaxed">
              Complete development of the MVP release candidate including the
              Protocol Library with advanced search and filtering capabilities,
              front-end submission workflow for contributors, and reviewer
              publishing flow with proper permissions and validation.
            </p>
          </div>
            ...
            <div className="space-y-4">
              {dependencies.map((dependency, index) => (
                <div key={index} className="flex items-center justify-between">
                  ...
                  <span
                    className={`text-sm font-medium ${dependency.statusColor}`}
                  >
                    {dependency.status}
                  </span>
                </div>
          ...
          <div>
            ...
            <div className="bg-gray-50 border-l-4 border-gray-300 p-4 rounded">
              <p className="text-gray-700 text-sm leading-relaxed">
                Performance testing with large datasets is critical. Need to
                ensure caching strategy is properly implemented before launch.
              </p>
            </div>
          </div>
        </div>
